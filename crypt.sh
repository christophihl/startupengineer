...
find ./public/_repos/dat_sci_3 -maxdepth 1 -type f -name "*.html" -exec staticrypt {} -p $(echo "$password_encoded_2_3" | openssl enc -d -base64) --short -d ./public/_repos/dat_sci_3 --template-instructions "Access to Course Materials" --template-color-primary "#005E73" --template-color-secondary "#2DC6D6" --template-button "LOGIN" \;

...
1) How should Vine Brook evaluate each of these potential investments? Use the [`Venture Evaluation Matrix Spreadsheet Tool`](https://www.dropbox.com/s/pdtntrytcra7852/VEM-Spreadsheet-Tool.xlsx?dl=0) to structure your evaluation.
...
2)	Calculate the value of the abandonment option embedded in the Bridge round by mapping out two scenarios in the form of decision trees: <br/>

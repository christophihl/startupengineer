...
In your assignment folder you will find a `.Rmd` file that contains all instructions and also intermediate results in case you get stuck. You can knit the `.Rmd` file to a pdf file by clicking the knit button.
